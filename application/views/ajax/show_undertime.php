...
<th width="9%" bgcolor="#D6D6D6"><strong>Employee No. </strong></th>
<th width="25%" bgcolor="#D6D6D6"><strong>Employee Name </strong></th>
<th width="11%" bgcolor="#D6D6D6"><strong>Particulars</strong></th>
<th width="10%" bgcolor="#D6D6D6">Vacation Leave Equivalent</th>
<th width="28%" bgcolor="#D6D6D6">Date and Action<br /></th>
<th width="17%" bgcolor="#D6D6D6"><span style="font-weight: bold">Actions</span></th>
</tr>
<?php
foreach($rows as $row)
{
...
<td align="right"><?php echo number_format($row['v_abs'], 3);?></td>
