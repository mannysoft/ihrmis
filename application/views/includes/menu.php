...
$employee_management = array(
						...
						$base.'personnel_admin/plantilla">'.$image.'Plantilla of Personnel</a>',
...
if ( $this->session->userdata('user_type') == 5)
{
	$leave_management = array(
						...
						$base.'manual_manage/cto_apps">'.$image.'CTO Application</a>'
            			);
...
<li class="menu_close"><a class="first_line" href="<?php echo base_url();?>home/home_page"><img src="<?php echo base_url();?>/images/classroom_classroom.png" alt=".:" width="22" height="22" class="little_icon"><br>
 ...
 || $this->session->userdata('user_type') == 7):?>
      ...
      <?php endif; ?>
  		...
  		<!--View if records admin system admin and super admin-->
  		<?php if ( $this->session->userdata('user_type') == 1 || $this->session->userdata('user_type') == 2
		|| $this->session->userdata('user_type') == 7):?>
  ...
  <?php 
  if ( $this->session->userdata('user_type') == 6 || $this->session->userdata('user_type') == 8 || $this->session->userdata('user_type') == 5)
  {
	  $attendance_management = array(
						$base.'attendance_manage/view_attendance">'.$image.'View Attendance</a>',
						$base.'dtr_manage/dtr">'.$image.'DTR</a>',
  ...
  <li class="menu_close"><a class="first_line" href="?q=10" onClick="return false;"><img src="<?php echo base_url();?>/images/field_manager_field_list.png" alt=".:" width="22" height="22" class="little_icon"><br>
  DTR</a>
...
<?php if ( $this->session->userdata('user_type') == 1 || $this->session->userdata('user_type') == 2 || $this->session->userdata('user_type') == 5 || $this->session->userdata('user_type') == 6):?>	  
