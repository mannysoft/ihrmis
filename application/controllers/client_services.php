...
class Client_services extends Controller {
	...
	function sample()
	{
		...
		$server_url = 'http://localhost/ats2/server_services/';
	...
	function check_updates($system_name = '', $installed_version = '', $license = '')
	{
		...
		else
		{
			...
			{
				echo 'You already have the latest version of ATLMS installed.';
			}
		}
	}
