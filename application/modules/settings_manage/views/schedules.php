...
<table id="dtr.table" width="100%" border="0" class="type-one">
  ...
  <tr bgcolor="<?php echo $bg;?>" onmouseover="this.bgColor = '#ABC7E9';this.style.color='#000000';" 
    ...
    <td><?php echo $times['am_in_hour'].':'.$times['am_in_min'];?></td>
    <td><?php echo $times['am_out_hour'].':'.$times['am_out_min'];?></td>
    <td><?php echo $times['pm_in_hour'].':'.$times['pm_in_min'];?></td>
    <td><?php echo $times['pm_out_hour'].':'.$times['pm_out_min'];?></td>
