...
$tardy_autodeduct1 = '';
$tardy_autodeduct2 = '';
if ($settings['tardy_autodeduct'] == 'yes')
{
	$tardy_autodeduct1 = 'checked="checked"';
}
else
{
	$tardy_autodeduct2 = 'checked="checked"';
}
...
$auto_generate_employee_id1 = '';
$auto_generate_employee_id2 = '';

if ($settings['auto_generate_employee_id'] == 'yes')
{
	$auto_generate_employee_id1 = 'checked="checked"';
}
else
{
	$auto_generate_employee_id2 = 'checked="checked"';
}
...
<table width="100%" border="0">
  <tr>
    <td width="15%">&nbsp;</td>
    <td width="32%"><input name="op" type="hidden" id="op" value="1" />
	<?php 
	$u = new User_m();
  ...
  <tr>
    ...
    <td align="right" bgcolor="#CCCCCC">Auto deduct Tardiess to leave credits:</td>
  ...
  <tr>
    <td align="right" bgcolor="#CCCCCC">Auto Generate Employee No.:</td>
