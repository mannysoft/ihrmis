...
<table width="100%" border="0">
  <tr>
    <td width="88%"><strong>User ID:</strong>
      ...
      <div id="added"></div></td>
    <td width="1%">&nbsp;</td>
    <td width="11%"><a href="<?php echo base_url();?>user_manage/add_user">Add user</a> </td>
  </tr>
</table>
...
<table width="100%" border="0" class="type-one">
    ...
    onmouseout ="this.bgColor = '<?php echo $bg;?>';this.style.color='#000000'">
        ...
        <td bgcolor=""><?php //if($this->session->userdata('user_type')==1){?>
          <a href="<?php echo base_url();?>user_manage/edit_user/<?php echo $row['username'];?>">Edit</a> | 
		  <a href="#" onclick="delete_user('<?php echo $row['username'];?>','Delete User <?php echo $row['lname'].', '.$row['fname'];?>?', '<?php echo base_url();?>user_manage/delete_user/<?php echo $row['username'];?>')">Delete</a>
        </td>
        </tr>
		<?php endforeach;?>
      <tr>
