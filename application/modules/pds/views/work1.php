    ...
    <fieldset class="adminform">
      ...
      <table width="100%" cellspacing="1" class="admintable">
                              <tbody>
                                <tr>
                                  <td colspan="2" align="center" valign="top" >INCLUSIVE DATES<br />
                                    (yyyy-mm-dd)</td>
                                  <td width="19%" align="center">POSITION/ TITLE <br />
                                    (Write in full) </td>
                                  <td width="20%" align="center">DEPARTMENT/ OFFICE/COPANY<br />
                                    (Write in full)</td>
                                  <td width="10%" align="center">MONTHLY SALARY </td>
                                  <td width="9%" align="center">SALARY GRADE/ &amp; STEP INC.<br />
                                    (Format &quot;00-0&quot;)</td>
                                  <td width="18%" align="center">STATUS OF APPOINTMENT </td>
				...
				<tr>
				  ...
				  <td><input name="work_sg[]" type="text" id="work_sg[]" value="<?php echo $work->salary_grade;?>" size="5" /></td>
			  	...
			  	<?php if ($i <= 50): ?>
			  	 	<?php while($i != 50): ?>
                        ...
                        <tr>
                          ...
                          <td><input name="work_sg[]" type="text" id="work_sg[]" value="" size="5" /></td>
