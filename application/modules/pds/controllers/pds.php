...
class Pds extends MX_Controller  {
	...
	function personal_info( $employee_id = '' )
	{
		...
		if ( $this->input->post('op'))
		{
			...
			*/
			//$e->birth_date		= $this->input->post('birth_date');
			//$e->sex				= $this->input->post('sex');
			//$e->res_address		= $this->input->post('res_address');
	...
	function training_preview( $employee_id = '' , $report_name = '')
	{
		...
		<table width="100%" border="0" cellpadding="5">
		  <tr>
			<td colspan="4" align="center" style="font-size:18px;">&nbsp;</td>
		  </tr>
		  <tr>
			<td colspan="4" align="center" style="font-size:18px;">&nbsp;</td>
		  </tr>
...
<div id="apDiv1"><img src="'.base_url().'images/logo.jpg" alt="" name="logo" width="110" height="110"/></div>
