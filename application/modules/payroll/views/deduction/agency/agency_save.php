...
<form action="" method="post">
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <td>
        <input name="agency_name" type="text" id="agency_name" value="<?php echo $deduction->agency_name;?>" size="45" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><label for="report_order">Order:</label></td>
      <td>
        <input name="report_order" type="text" id="report_order" value="<?php echo $deduction->report_order;?>" size="45" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" name="button" id="button" value="Save" />
        <a href="<?=base_url().'payroll/deduction/agency'?>">Cancel</a>
