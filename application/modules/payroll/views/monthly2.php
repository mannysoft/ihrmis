...
<table width="100%" border="0" class="type-one">
  <tr class="type-one-header">
    ...
    <th width="8%" class="official_deductions">&nbsp;</th>
    <th class="official_deductions">&nbsp;</th>
    <th width="4%" class="official_deductions">&nbsp;</th>
    </tr>
  <tr class="type-one-header">
    <th>&nbsp;</th>
    <th>&nbsp;</th>
    ...
    <?php foreach($agencies as $agency):?>
		<?php 
			...
			$colspan = ($colspan != 0 and $colspan != 1) 
						? 'colspan="'.$colspan.'"' 
						: '';
			
        ?>
    	<th <?php echo $colspan;?>><?php echo $agency->code.'-'.$agency->id;?></th>
    <?php endforeach;?>
    <th>&nbsp;</th>
    </tr>
  <tr class="type-one-header">
  ...
  <?php foreach ($employees as $employee): ?>
		...
		$monthly_salary = $this->Salary_grade->get_monthly_salary($employee->salary_grade, $employee->step, 2011);
