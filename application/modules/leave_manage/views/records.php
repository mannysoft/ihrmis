...
<table width="100%" border="0" class="type-one">
  <tr class="type-one-header">
    <th width="9%"><strong>Employee ID </strong></th>
    <th width="25%"><strong>Employee Name </strong></th>
    <th width="30%">Office</th>
    <th width="18%"><strong>Leave Credits </strong></th>
  ...
  <tr bgcolor="<?php echo $bg;?>" onmouseover="this.bgColor = '<?php echo $this->config->item('mouseover_linecolor')?>';" 
    ...
    &nbsp;<img src="<?php echo base_url();?>images/poll_poll.png" title="Statement of Vacation and Sick Leave Creadits" onclick="openBrWindow('<?php echo base_url();?>leave_manage/reports/statement_leave/<?php echo $state_no.'/'.$employee_id;?>','','scrollbars=yes,width=700,height=700')" style="cursor: pointer;"/>
    
    <img src="<?php echo base_url();?>images/classevent_main.png" title="History" onClick="openBrWindow('<?php echo base_url();?>leave_manage/leave_card/<?php echo $employee_id;?>','','scrollbars=yes,width=900,height=600')" style="cursor: pointer;"/>
    
    
    <a href="#" title="Terminal Leave" onClick="openBrWindow('<?php echo base_url();?>leave_manage/reports/money_value/0/<?php echo number_format($total_leave['sick'] + $total_leave['vacation'], 3);?>/<?php echo $employee_id;?>','','scrollbars=yes,width=900,height=700')" style="cursor: pointer;"/>Terminal Leave</a>
