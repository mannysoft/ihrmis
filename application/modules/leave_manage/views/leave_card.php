...
if ($q->num_rows() > 0)
{
	foreach ($q->result_array() as $row)
	{
		...
		$first_day_of_service = $row['first_day_of_service'];
		
		//list($month, $day, $year) = explode('/', $first_day_of_service);
		
		
		
		//echo substr($first_day_of_service, 0, 1).'<br>';
		
		if (substr($first_day_of_service, -1) == '-')
		{
			//echo substr($first_day_of_service, -1).'<br>';
			echo substr($first_day_of_service, 0, -1).'<br>';
			$data = array('first_day_of_service' => substr($first_day_of_service, 0, -1));
...
WOP</td>
	...
	<tr bgcolor="<?php //echo $bg;?>">
      ...
      <td align="center"><?php echo $v_earned;?></td>
      ...
      <td align="center"><?php echo $s_earned;?></td>
      <td align="center"><?php echo $s_abs;?></td>
      <td align="center"><?php echo $sick_leave_balance;?></td>
