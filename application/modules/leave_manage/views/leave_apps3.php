...
<table width="100%" border="0" class="type-one">
  ...
  <tr bgcolor="<?php echo $bg;?>" onmouseover="this.bgColor = '#ABC7E9';this.style.color='#000000';" 
	...
	else
	{
		...
		{
			?>
			<a href="#" class="approved_leave" leave_apps_id = "<?php echo $row['id'];?>">Approve</a> | <a href="<?php echo base_url();?>leave_manage/disapproved_leave/<?php echo $row['id'];?>" class="disapproved_leave">Disapprove</a>
			<?php
		}
	}
