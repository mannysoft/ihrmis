 ...
 * @author		Manny Isles
 * @link		http://charliesoft.net
 * @github	    http://github.com/mannysoft/ihrmis/hrmis/user_guide/models/asset_personal.html
 */
class Budget_expenditure_m extends DataMapper{

	// --------------------------------------------------------------------
	public $table  = 'budget_expenditures';
