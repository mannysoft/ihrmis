...
$(document).ready(function(){
	...
	$('#employee_list').load("<?php echo base_url().('personnel_admin/plantilla_ajax/plantilla/'.$selected.'/'.$year_selected); ?>" );
});

$('#office_id').change(function(){

	$('#employee_list').html("<b>Loading...</b>");
	$('#employee_list').load("<?php echo base_url().('personnel_admin/plantilla_ajax/plantilla/'); ?>" +$('#office_id').val() + "/" + $('#year').val());
});
