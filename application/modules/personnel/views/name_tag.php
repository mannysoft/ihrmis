<form action="<?php echo base_url()?>personnel/assets" method="post" class="myform">
...
<div class="clean-gray">
    <table width="100%" border="0" cellpadding="5" cellspacing="5">
      ...
      <tr>
        <td align="right"><a href="#" onclick="openBrWindow('<?php echo base_url();?>personnel/assets_preview/<?php echo $employee->id;?>','','scrollbars=yes,width=700,height=700');return false;" style="cursor: pointer;" title="PDS"/>Assets and Liabilities Print Preview</a></td>
        <td>&nbsp;</td>
        <td width="29%" align="center" valign="middle">&nbsp;</td>
      </tr>
    </table>
