...
class Migration_rename_hris_duties_table extends CI_Migration {
	...
	{			
		...
		if ( $this->db->table_exists('hris_duties'))
		{	
			$this->db->query('RENAME TABLE `hris_duties` TO `ats_employee_duties`'); 
		}
