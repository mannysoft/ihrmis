...
class Migration_create_payroll_philhealth_sched extends CI_Migration {
	...
	function up() 
	{	
		//$this->migrations->verbose AND print "creating payroll_philhealth_schedules table...";
	...
	function down() 
	{
		//$this->migrations->verbose AND print "dropping payroll_philhealth_schedules table...";
